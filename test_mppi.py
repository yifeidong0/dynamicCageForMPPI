...
if __name__ == "__main__":
    ...
    filename = "states_rollout_mppi.csv"
    ...
    filename_suc_label = "states_traj_success_labels.csv"
    ...
    filename_man_label = "states_traj_maneuver_labels.csv"
    ...
    filename_traj = "states_traj_mppi.csv"
